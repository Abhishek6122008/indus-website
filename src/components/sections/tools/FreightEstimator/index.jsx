...
import { Truck, AlertCircle, ArrowRight, MapPin, Scale, Package, Clock, HelpCircle } from 'lucide-react'
        ...
        <div className="p-6 sm:p-8 lg:col-span-5 bg-blue-50/50 flex flex-col justify-between">
          ...
          <div className="mt-8 pt-4 border-t border-blue-100">
            <div className="flex gap-2 text-[11px] text-slate-500 leading-relaxed">
              ...
              <span>
                <strong>Indicative estimates only:</strong> Final values may vary based on market conditions, toll fees, exact dimensional weight, and special handling fees.
              </span>
            </div>
          </div>
        </div>
